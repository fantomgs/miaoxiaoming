...
public class CandidateView extends View {
    ...
    private void onSizeChanged() {
        ...
        // FIXME: When we press left/right arrow, it will request Draw operation and CandidatesContainer.onMeasure
        // method will be called to layout all the view. Because the onMeasure in Relativelayout does not implemented correctly
        // in every case, the CandidateView will change size during CandidatesContainter.onMeasure method, which
        // will cause the page always stay in first page. So we disable this page change command.
