...
public class ManageAccountsSettings extends AccountPreferenceBase implements View.OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        IntentFilter intentFilter  = new IntentFilter(ConnectivityManager.ACTION_BACKGROUND_DATA_SETTING_CHANGED);
        this.registerReceiver(mBackgroundDataSettingChanged, intentFilter);
    ...
    public void onDestroy() {
        this.unregisterReceiver(mBackgroundDataSettingChanged);
        ...
        if (preference == mBackgroundDataCheckBox) {
            ...
            if (oldBackgroundDataSetting != backgroundDataSetting) {
                ...
                //    onSyncStateUpdated();
                    ...
                    Log.d(TAG,"onPreferenceTreeClick bg checked=" + true);
    ...
    protected void onSyncStateUpdated() {
        ...
        Log.d(TAG,"onSyncStateUpdated bg checked=" + backgroundDataSetting);
    ...
    public void onAccountsUpdated(Account[] accounts) {
        ...
        for (int i = 0, n = accounts.length; i < n; i++) {
            ...
            if (ACCOUNT_TYPE_PHONE.equals(account.type) ||
                ACCOUNT_TYPE_SIM.equals(account.type)) {
                showAccount = false;
            }
