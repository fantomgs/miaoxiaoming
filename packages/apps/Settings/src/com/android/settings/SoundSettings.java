...
public class SoundSettings extends PreferenceActivity implements
    ...
    private static final String KEY_MULTI_SIM_SOUND = "multi_sim_sound";
    ...
    private final int mResources[] = {R.xml.sound_settings, R.xml.sound_settings_multi_sim};
	...
	private PreferenceScreen mMultiSimSound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMultiSimSound = (PreferenceScreen) findPreference(KEY_MULTI_SIM_SOUND);
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (mMultiSimSound != null && preference == mMultiSimSound) {
            Intent intent = mMultiSimSound.getIntent();
