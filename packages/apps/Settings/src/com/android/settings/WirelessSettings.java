...
public class WirelessSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		{
			bt = (CheckBoxPreference) findPreference(KEY_TOGGLE_BLUETOOTH);
			mBtEnabler = new BluetoothEnabler(this, bt);
		}
            ...
            if (wifiRegexs.length == 0) {
                ...
                if (usbRegexs.length == 0) {
                    ...
                    if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
                        p.setSummary(R.string.tether_settings_summary_wifi_cta);
                    }else{
                    ...
                    if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
                        p.setSummary(R.string.tether_settings_summary_both_cta);
                    }else{
    ...
    private void updateCTARes(){
        if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
            findPreference(KEY_WIFI_SETTINGS).setTitle(R.string.wifi_settings_cta);
        }
    }
