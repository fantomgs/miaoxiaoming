...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    public static final String SETIINGS_CHANGE_ACTION="android.appwidget.action.SETTINGS_CHANGED";
    ...
    private static final class WifiStateTracker extends StateTracker {
        ...
        protected void requestStateChange(Context context, final boolean desiredState) {
            ...
            Log.d(TAG, "wifiManager WIFI_SERVICE.");
            if (wifiManager == null) {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... args) {
                    ...
                    Log.d(TAG, "wifiManager wifiApState="+wifiApState);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if(!SETIINGS_CHANGE_ACTION.equals(intent.getAction())){
