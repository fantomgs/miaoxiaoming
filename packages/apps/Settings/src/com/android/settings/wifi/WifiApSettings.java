...
public class WifiApSettings extends PreferenceActivity
    ...
    private static final int CONFIG_SUBTEXT_CTA = R.string.wifi_tether_configure_subtext_cta;
    ...
    private void updateCTARes(){
        if(mWifiConfig == null) {
            ...
            if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
                mCreateNetwork.setSummary(String.format(getString(CONFIG_SUBTEXT_CTA),
        ...
        if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
            setTitle(R.string.wifi_tether_settings_title_cta);
            mCreateNetwork.setTitle(R.string.wifi_tether_configure_ap_text_cta);
        }
    }
