...
public class WifiEnabler implements Preference.OnPreferenceChangeListener {
    ...
    private CharSequence getSummary() {
        String original = mCheckBox.getSummary().toString();
        String toggleTitle = mContext.getString(R.string.wifi_quick_toggle_summary);
        String toggleTitleCTA = mContext.getString(R.string.wifi_quick_toggle_summary_cta);
        if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
            if(original.equalsIgnoreCase(toggleTitle) || original.equalsIgnoreCase(toggleTitleCTA)){
                return toggleTitleCTA;
            }
        }
    ...
    private void updateCTARes(){
        if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
            mCheckBox.setTitle(R.string.wifi_quick_toggle_title_cta);
            mCheckBox.setSummary(getSummary());
        }
