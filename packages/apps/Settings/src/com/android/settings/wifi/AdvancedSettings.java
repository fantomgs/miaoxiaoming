...
public class AdvancedSettings extends PreferenceActivity
    ...
    private void updateCTARes(){
        if (FeatureQuery.FEATURE_SETTINGS_CTA_REQUIREMENTS) {
            mSleepPolicyPref.setTitle(R.string.wifi_setting_sleep_policy_title_cta);
            mSleepPolicyPref.setSummary(R.string.wifi_setting_sleep_policy_summary_cta);
            mSleepPolicyPref.setDialogTitle(R.string.wifi_setting_sleep_policy_title_cta);
        }
    }
    ...
    private void initSleepPolicyPreference() {
        ...
        mSleepPolicyPref.setValue(String.valueOf(value));
    }
