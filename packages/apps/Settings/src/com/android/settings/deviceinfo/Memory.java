...
public class Memory extends PreferenceActivity implements OnCancelListener {
    ...
    private static final int DLG_PROGRESS_MOUNT = 3;
    private static final int MSG_MOUNT_FINISH = 1;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Utils.updatePreferenceToSpecificActivityOrRemove(this, (PreferenceGroup)this.findPreference("memory_sd"),
                STORAGE_MGR_KEY,
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mSdMountToggle) {
            ...
            if (status.equals(Environment.MEDIA_MOUNTED)) {
                ...
                //mount();
                showDialogInner(DLG_PROGRESS_MOUNT);
            }
            return true;
    ...
    final Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == MSG_MOUNT_FINISH){
                if(mProgressDialog != null)
                    mProgressDialog.dismiss();
            }
        }
    };
    // process  mount asynchronously in a thread
    ...
    public Dialog onCreateDialog(int id, Bundle args) {
        ...
        case DLG_PROGRESS_MOUNT:
            ...
            mProgressDialog.setMessage(mRes.getString(R.string.sd_mounting));
    ...
    private void updateMemoryStatus() {
        ...
        if (status.equals(Environment.MEDIA_MOUNTED)) {
            ...
            if (status.equals(Environment.MEDIA_UNMOUNTED) ||
                ...
                mSdMountToggle.setEnabled(true);
                //if the media is unmount,cann't format it
                mSdFormat.setEnabled(false);
                ...
                mSdMountToggle.setEnabled(false);
                mSdFormat.setEnabled(false);
                mSdMountToggle.setSummary(mRes.getString(R.string.sd_checking_summary));
            }else {
                mSdMountToggle.setEnabled(false);
                mSdFormat.setEnabled(false);
                mSdMountToggle.setTitle(mRes.getString(R.string.sd_mount));
