...
public class AccessibilitySettings extends PreferenceActivity {
    ...
    private AlertDialog mNoAppsAlert = null;
    ...
    protected void onResume() {
		...
		if ( DEBUG ) Log.d(TAG, "accessibilityServices.isEmpty() : " + accessibilityServices.isEmpty());
    ...
    private void displayNoAppsAlert() {
    	...
    	if ( DEBUG ) Log.d(TAG, "displayNoAppsAlert!!!!!!!!!!");
        ...
        try {
            ...
            if ( DEBUG ) Log.d(TAG, "NameNotFoundException!!!!!!!!!!");
            getPreferenceScreen().removePreference(mToggleCheckBox);
            mToggleCheckBox = null;
            return;
        }
        
        mNoAppsAlert = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                    int which) {
                                String screenreaderMarketLink = SystemProperties
                                        .get("ro.screenreader.market",
                                                DEFAULT_SCREENREADER_MARKET_LINK);
                                Uri marketUri = Uri
                                        .parse(screenreaderMarketLink);
