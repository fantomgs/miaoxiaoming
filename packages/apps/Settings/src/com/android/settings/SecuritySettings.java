...
public class SecuritySettings extends PreferenceActivity {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
		...
		{
			iccLockPreferences.setTitle(R.string.icc_uim_lock_settings_category);
		}
		else
		{
		...
		if(SystemProperties.get("ro.product.customer_id").equals("JC_A107")||SystemProperties.get("ro.product.customer_id").equals("W706"))
		{
			iccLockCat.setTitle(R.string.icc_uim_lock_settings_title);
		}
		else
		{
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        SecuritySettings.this.sendBroadcast(
				new Intent(SettingsAppWidgetProvider.SETIINGS_CHANGE_ACTION));
        return false;
    }
