...
public class SearchActivity extends ListActivity
{
    ...
    public static class TextViewSnippet extends TextView {
        ...
        /*
         * Remove it because the Chinese character couldn't display as bold very clear,
         * and change to use foreground color to display.
         */
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            while (m.find(start)) {
                spannable.setSpan(new ForegroundColorSpan(Color.RED), m.start(), m.end(), 0);
                start = m.end();
            }
            setText(spannable);
