...
public class AttachmentEditor extends LinearLayout {
    ...
    private class MessageOnClick implements OnClickListener {
        ...
        public void onClick(View v) {
            if (mWhat == MSG_PLAY_SLIDESHOW ||
                    mWhat == MSG_EDIT_SLIDESHOW) {
                setPlayAndEditButtonEnabled(false);
            }
    ...
    private SlideViewInterface createSlideshowView(boolean inPortrait) {
        ...
        mEditBtn = (Button) view.findViewById(R.id.edit_slideshow_button);
        ...
        mEditBtn.setOnClickListener(new MessageOnClick(MSG_EDIT_SLIDESHOW));
    ...
    public void setPlayAndEditButtonEnabled(boolean enabled) {
        if (mPlayBtn != null && mEditBtn != null) {
