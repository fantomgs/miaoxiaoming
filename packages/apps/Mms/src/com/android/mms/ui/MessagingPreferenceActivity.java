...
import com.android.mms.ui.SelectSubscription;
...
public class MessagingPreferenceActivity extends PreferenceActivity {
    ...
    private boolean hasIccCard() {
        ...
        for (int i = 0; i < tm.getPhoneCount(); i++) {
            hasIccCard = hasIccCard || tm.hasIccCard(i);
    ...
    private void setMessagePreferences() {
        ...
        //we should judge both card slot 1 and slot 2 to see if there is no sim card or not
        if ( !hasIccCard()) {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mSmsLimitPref) {
            ...
            if (!TelephonyManager.isMultiSimEnabled() || hasIccCardCount() <= 1) {
                startActivity(new Intent(this, ManageSimMessages.class));
            } else {
                Intent intent = new Intent(this, SelectSubscription.class);
                intent.putExtra(SelectSubscription.PACKAGE, "com.android.mms");
                intent.putExtra(SelectSubscription.TARGET_CLASS, "com.android.mms.ui.ManageSimMessages");
