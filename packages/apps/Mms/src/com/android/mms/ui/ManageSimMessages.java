...
public class ManageSimMessages extends Activity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        int subscription = getIntent().getIntExtra(SelectSubscription.SUBSCRIPTION_ID, SUB_INVALID);
        ...
        switch (item.getItemId()) {
            ...
            case MENU_DELETE_FROM_SIM:
				if(SystemProperties.get("ro.product.customer_id").equals("JC_A107")||SystemProperties.get("ro.product.customer_id").equals("W706"))
				{
                	...
                	}, R.string.confirm_delete_UIM_message);
				}
				else
				{
                	confirmDeleteDialog(new OnClickListener() {
        ...
        switch (item.getItemId()) {
            case OPTION_MENU_DELETE_ALL:
				if(SystemProperties.get("ro.product.customer_id").equals("JC_A107")||SystemProperties.get("ro.product.customer_id").equals("W706"))
				{
                	...
                	}, R.string.confirm_delete_all_UIM_messages);
				}
				else
				{
                	confirmDeleteDialog(new OnClickListener() {
    ...
    private void updateState(int state) {
        ...
        switch (state) {
            case SHOW_LIST:
				...
				if(SystemProperties.get("ro.product.customer_id").equals("JC_A107")||SystemProperties.get("ro.product.customer_id").equals("W706"))
				{
					setTitle(getString(R.string.uim_manage_messages_title));
				}
				else
				{
