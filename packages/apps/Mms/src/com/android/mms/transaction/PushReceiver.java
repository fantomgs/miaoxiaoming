...
public class PushReceiver extends BroadcastReceiver {
        ...
        protected Void doInBackground(Intent... intents) {
            ...
            if ("application/vnd.wap.sic".equals(intent.getType()) || "application/vnd.wap.slc".equals(intent.getType())) {
                ...
                try {
                    ...
                    Uri pushMsgUri = handler.handle(bais, intent.getType(), mContext, intent.getIntExtra("sub_id", 0));
                ...
                switch (type) {
                    ...
                    case MESSAGE_TYPE_NOTIFICATION_IND: {
                        ...
                        if (!isDuplicateNotification(mContext, nInd)) {
                            ...
                            MessagingNotification.nonBlockingUpdateNewMessageIndicator(mContext, true,
                                    false);

                            if (TelephonyManager.isMultiSimEnabled() && MmsConfig.getDataSubscription() != subId) {
                                break;
                            }
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(WAP_PUSH_RECEIVED_ACTION)
                && (ContentType.MMS_MESSAGE.equals(intent.getType()) || "application/vnd.wap.sic".equals(intent.getType()) || "application/vnd.wap.slc".equals(intent.getType()))) {
            if (LOCAL_LOGV) {
