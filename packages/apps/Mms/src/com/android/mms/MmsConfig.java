...
public class MmsConfig {
    ...
    /**  
    * Get the data subscription to be used for MMS.  
    */  
    public static int getDataSubscription() {  
        return TelephonyManager.getDefault().getPreferredDataSubscription(); 
    }
    ...
    public static boolean restoreDataSubscription() {
        if (sDefaultDataSubscription == SUBSCRIPTION_INVALID)
    	    return false;
        boolean result = TelephonyManager.setPreferredDataSubscription(sDefaultDataSubscription);
        return result;
    }

    public static boolean needDataSwitch() {
        return sDefaultDataSubscription != SUBSCRIPTION_INVALID
                    && sDefaultDataSubscription != getDataSubscription();
    }
