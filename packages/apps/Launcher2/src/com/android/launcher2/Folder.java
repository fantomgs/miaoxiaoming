...
public class Folder extends LinearLayout implements DragSource, OnItemLongClickListener,
    ...
    public void onItemClick(AdapterView parent, View v, int position, long id) {
        ...
        final ComponentName componentName = app.intent.getComponent();
        if (componentName != null) {
            final String packageName = componentName.getPackageName();
            final String className = componentName.getClassName();
            Utilities.updateLaunchInfo(mLauncher.getContentResolver(),packageName,className);
            if (mLauncher.getSharedPreferences().getInt("sortby", 0) != 0) {
                mLauncher.updateSort(packageName, className);
            }
        }
    }
