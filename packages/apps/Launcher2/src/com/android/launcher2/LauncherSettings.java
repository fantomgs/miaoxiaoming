...
class LauncherSettings {
    ...
    static final class ThemeInfo {
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_THEME_INFO);

        static final String THEME_NAME = "themeName";
        static final String WALLPAPER_TYPE = "wallpaperType";
        static final String WALLPAPER_INFO = "wallpaperInfo";
        static final String IS_SAVED = "isSaved";

        static final int TYPE_FILE = 1;
        static final int TYPE_LIVE = 2;
    }

    static final class ThemeFavorites {
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_THEME_FAVORITES);
