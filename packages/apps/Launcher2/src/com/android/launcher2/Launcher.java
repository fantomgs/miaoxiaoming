...
public final class Launcher extends Activity
    ...
    private static final int MENU_SORT = MENU_SETTINGS + 1;
    ...
    private void setWallpaperDimension() {
        ...
        int needReload = Settings.System.getInt(getContentResolver(), SETTINGS_THEME_RELOAD, 0);
        if (needReload == 1) {
            try {
                Config config = Config.getInstance(this);
                int wallpaperType = config.getWallpaperType();
                switch (wallpaperType) {
                    case LauncherSettings.ThemeInfo.TYPE_FILE: {
                        Bitmap bitmap = config.getWallpaperBitmap();
                        if (bitmap != null) {
                    ...
                    case LauncherSettings.ThemeInfo.TYPE_LIVE: {
                        ComponentName wallpaperComponent = config.getWallpaperComponent();
                        if (wallpaperComponent != null) {
                            wpm.getIWallpaperManager().setWallpaperComponent(wallpaperComponent);
                        }
                        break;
                    }
                    default:
                        wpm.setResource(config.getWallpaper());
                        break;
                }
            } catch (IOException e) {
                Log.e(TAG, "Failed to set wallpaper: " + e);
            } catch (RemoteException re) {
                Log.e(TAG, "Failed to set live wallpaper: " + re);
            }
        }
    }
    ...
    */
    ...
    private void setupViews() {
        ...
        Panel mPanel = new Panel(this);
        dragLayer.addView(mPanel);
        FrameLayout.LayoutParams flp = new FrameLayout.LayoutParams(
                FrameLayout.LayoutParams.FILL_PARENT, Config.getInstance(this).getPanelHeight(),
                Gravity.BOTTOM);
        mPanel.setLayoutParams(flp);
        mPanel.setLauncher(this);
        mPanel.setWorkspace(mWorkspace);
        mPanel.setScreenIndicator();
        mPanel.setPreferenceShortcut();
        ...
        deleteZone.setHandle(mPanel.getAllAppsButtonCluster());
...
/*
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.setGroupVisible(MENU_GROUP_SORT, !visible);
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            if (componentName != null) {
                ...
                Utilities.updateLaunchInfo(getContentResolver(),packageName,className);
    ...
    private class CreateShortcut implements DialogInterface.OnClickListener,
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which) {
                ...
                case AddAdapter.ITEM_THEME: {
                    mWaitingForResult = false;
                    Intent intent = new Intent(Intent.ACTION_MAIN);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.setClassName("com.android.settings", "com.android.settings.ThemeSettings");
                    startActivity(intent);
                    break;
                }
            }
    ...
    public void finishBindingItems() {
        ...
        if (mSavedInstanceState != null) {
            /**
             * restore instance state by restoreState().
             */
    ...
    public void bindAllApplications(ArrayList<ApplicationInfo> apps) {
        ...
        mAllAppsGrid.setApps(apps,sort_by);
    }
    ...
    public void bindAppsAdded(ArrayList<ApplicationInfo> apps) {
        ...
        int sort_by = mSharedPreferences.getInt("sortby", 0);
        mAllAppsGrid.addApps(apps,sort_by,false);
    ...
    public void bindAppsUpdated(ArrayList<ApplicationInfo> apps) {
        ...
        int sort_by = mSharedPreferences.getInt("sortby", 0);
        mAllAppsGrid.updateApps(apps,sort_by);
    }
    ...
    public void removeAppInfo(ArrayList<ApplicationInfo> apps){
        ...
        Log.i(TAG,"removeAppInfo(): selection="+selection+" && selectionArgs size="+selectionArgs.length);
        ...
        builder.setPositiveButton(android.R.string.ok, mSortListener);
    ...
    private class MyPreferenceChangeListener implements SharedPreferences.OnSharedPreferenceChangeListener{
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
            ...
            if(key.equals("sortby")){
                ...
                Log.i(TAG,"onSharedPreferenceChanged(): sortby="+sortBy+" && size="+mModel.getAppsList().size());
                //mAllAppsGrid.sortApp(mModel.getAppsList(),sortBy);
                mAllAppsGrid.sortApp(sortBy);
            }
        }
    ...
    public void updateSort(String packageName,String className){
        mAllAppsGrid.updateOnClick(packageName,className);
    }
