...
class InCallMenuView extends ViewGroup {
    ...
    InCallMenuView(Context context, InCallScreen inCallScreen) {
		...
		if (DBG) log("ro.product.resolution=" + SystemProperties.get("ro.product.resolution"));
		if(SystemProperties.get("ro.product.resolution").equals("640*960"))
		{
	        mRowHeight = a.getDimensionPixelSize(
	                com.android.internal.R.styleable.IconMenuView_rowHeight, 128);
		}
		else if(SystemProperties.get("ro.product.resolution").equals("320*480"))
		{
	        mRowHeight = a.getDimensionPixelSize(
	                com.android.internal.R.styleable.IconMenuView_rowHeight, 64);
		}
		else if(SystemProperties.get("ro.product.resolution").equals("240*320"))
		{
	        mRowHeight = a.getDimensionPixelSize(
	                com.android.internal.R.styleable.IconMenuView_rowHeight, 64);
		}	
