...
public class Settings extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (getResources().getBoolean(R.bool.world_phone) == true) {
            ...
            if (SystemProperties.getBoolean("ro.monkey", false)) {
                ...
                mButtonPreferredNetworkMode.setValue(Integer.toString(settingsNetworkMode));
                mCdmaOptions = new CdmaOptions(this, prefSet, mSubscription);
    ...
    private void setScreenState() {
        ...
        if (TelephonyManager.isMultiSimEnabled()) {
            ...
            /*
             *  NOTICE:
             *      In DSDS mode, SLOT2, i.e. mSubscrition = 1,
             *      only supports GSM mode, so always set this button disabled
             */
    ...
    private void UpdatePreferredNetworkModeSummary(int NetworkMode) {
        ...
        switch(NetworkMode) {
            ...
            case Phone.NT_MODE_GSM_UMTS:
				...
				{
                	mButtonPreferredNetworkMode.setSummary(getString(R.string.gsm_wcdma_auto));
				}
                break;
            case Phone.NT_MODE_CDMA:
                mButtonPreferredNetworkMode.setSummary(getString(R.string.cdma_evdo_auto));
                break;
            case Phone.NT_MODE_CDMA_NO_EVDO:
            ...
            case Phone.NT_MODE_LTE_ONLY:
                ...
                break;
            case Phone.NT_MODE_GLOBAL:
                mButtonPreferredNetworkMode.setSummary(getString(R.string.global_auto));
                break;
            case Phone.NT_MODE_GLOBAL_LTE:
