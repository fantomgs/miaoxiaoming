...
import android.os.SystemProperties;	//Add By zzg 2012_08_25
...
public class CallIndependentServices extends PreferenceActivity
	...
	private static final String REJECT_CALL_KEY   = "reject_call_setting_key";
    private static final String DISPLAY_HOME_LOCATION_KEY   = "display_home_location_key";

	private static final String AUTO_CALL_RECORD  = "auto_call_record_key";	//Add By zzg 2012_08_25
    ...
    private CheckBoxPreference mRejectCall;
	
	private CheckBoxPreference mAutoCallRecord;	//Add By zzg 2012_08_25
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        } else if (preference == mRejectCall) {
            handleRejectCallChange(preference, objValue);
        } else if (preference == mDisplayHomeLocation) {
            handleDisplayHomeLocationChange(preference, objValue);
        }
		
		//Add By zzg 2012_08_25
		else if (SystemProperties.get("ro.product.customer_id").equals("B707"))
		{
			if (preference == mAutoCallRecord) {
            	handleAutoCallRecordChange(preference, objValue);
	        }
		}
		//Add End
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mRejectCall = (CheckBoxPreference)findPreference(REJECT_CALL_KEY);
        mRejectCall.setOnPreferenceChangeListener(this);

		//Add By zzg 2012_08_25
		if (SystemProperties.get("ro.product.customer_id").equals("B707"))
		{
			mAutoCallRecord = (CheckBoxPreference)findPreference(AUTO_CALL_RECORD);
	        mAutoCallRecord.setOnPreferenceChangeListener(this);
		}
		//Add End
		...
		{
			prefSet.removePreference(mDisplayHomeLocation);
		}
		//end
    ...
    protected void onResume() {
        ...
        if (mRejectCall != null) {
            ...
            mRejectCall.setChecked(enabled);
        }

		//Add By zzg 2012_08_25
		if (SystemProperties.get("ro.product.customer_id").equals("B707"))
		{
			if (mAutoCallRecord != null) {
	            boolean enabled = Settings.System.getInt(mPhone.getContext().getContentResolver(),
	                    "CALL_RECORD", 0) == 1;
	            mAutoCallRecord.setChecked(enabled);
	        }			
		}
		//Add End
        ...
        if (mDisplayHomeLocation!= null) {
            ...
            mDisplayHomeLocation.setChecked(enabled);
        }
    }

	//Add By zzg 2012_08_25
	private void handleAutoCallRecordChange(Preference preference, Object objValue) {
        boolean isEnabled = Boolean.parseBoolean(objValue.toString());

			
        android.provider.Settings.System.putInt(getContentResolver(),
                "CALL_RECORD", isEnabled ? 1 : 0);
    }
	//Add End

    private void handleRejectCallChange(Preference preference, Object objValue) {
        boolean isEnabled = Boolean.parseBoolean(objValue.toString());
        android.provider.Settings.System.putInt(getContentResolver(),
                Settings.System.REJECT_CALL_WITH_SMS, isEnabled ? 1 : 0);
    }
