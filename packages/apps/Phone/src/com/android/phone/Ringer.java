    ...
    void ring() {
        ...
        synchronized (this) {
            ...
            if ((mCustomRingtoneUri != null) && (mCustomRingtoneUri.equals(Settings.System.DEFAULT_RINGTONE_URI)
                    || mCustomRingtoneUri.equals(Settings.System.DEFAULT_RINGTONE_URI_2))) {
                String uriString = Settings.System.getString(mContext.getContentResolver(), mCustomRingtoneUri.getLastPathSegment());
