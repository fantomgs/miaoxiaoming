...
public class CdmaOptions {
    ...
    private PreferenceScreen mButtonCdmaAPNExpand;
    ...
    protected void create() {
        ...
        mButtonCdmaAPNExpand = (PreferenceScreen) mPrefScreen.findPreference(BUTTON_APN_EXPAND_KEY);
        mButtonCdmaAPNExpand.getIntent().putExtra(Settings.SUBSCRIPTION, mSubscription);
