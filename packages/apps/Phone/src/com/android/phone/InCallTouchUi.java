...
public class InCallTouchUi extends FrameLayout
    ...
    protected void onFinishInflate() {
        ...
        Configuration c = mIncomingCallWidget.getResources().getConfiguration();
        c.orientation = Configuration.ORIENTATION_PORTRAIT;
        mIncomingCallWidget.getResources().updateConfiguration(c, mIncomingCallWidget.getResources().getDisplayMetrics());
		...
		{
			//mBluetoothButton = (ToggleButton) mInCallControls.findViewById(1099);
    ...
    void updateInCallControls(Phone phone) {
        ...
        if (inCallControlState.canSwap) {
            if ((phoneType == Phone.PHONE_TYPE_GSM)
                ...
                mSwapButtonLabel.setText(R.string.menu_swapCalls);
            }
        }
