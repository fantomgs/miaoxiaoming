...
public class ContactsUtils {
     ...
     */
    public static void initiateCall(Context context, CharSequence phoneNumber, boolean ipCall, boolean editBeforeCall) {
        if (editBeforeCall) {
            // if edit before call, we will only send the phone number to dial.
            ...
            intent.putExtra(IPCALL_KEY,  ipCall);
            context.startActivity(intent);
        }
    }
