...
public class KindSectionView extends LinearLayout implements OnClickListener, EditorListener {
    ...
    /** this function should be called after function rebuildFromState be called.
    * Otherwise the visibility of delete button would be reset by function rebuildFromState.
    * @param visibility the visibility of delete button. should be View.VISIBLE, View.INVISIBLE or View.GONE
    */
    public void setDeleteVisibility(int visibility) {
        ...
        for (int i = 0; i < editorCount; i++) {
            ...
            editorView.mDelete.setVisibility(visibility);
        }
    }
