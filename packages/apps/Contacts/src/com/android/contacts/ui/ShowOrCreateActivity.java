...
public final class ShowOrCreateActivity extends Activity implements
    ...
    protected Dialog onCreateDialog(int id) {
	    ...
	    case CREATE_CONTACT_DIALOG:
                ...
                return new AlertDialog.Builder(this)
                        ...
                        .setOnKeyListener(new KeyPressListener(this))
                        .create();
        }
    ...
    // Close the parent when back key pressed.
    private static class KeyPressListener implements OnKeyListener {
        private Activity mParent;

        public KeyPressListener(Activity parent) {
                mParent = parent;
        }
