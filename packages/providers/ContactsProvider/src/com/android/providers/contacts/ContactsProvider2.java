...
public class ContactsProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    private static final int LOCAL_GROUPS = 3011;
    private static final int LOCAL_GROUPS_ID = 3012;
    private static final int LOCAL_GROUPS_LOOKUP = 3013;
    private static final int LOCAL_GROUPS_FILTER = 3014;
    ...
    static {
        ...
        matcher.addURI(ContactsContract.AUTHORITY, "data/local-groups", LOCAL_GROUPS);
        matcher.addURI(ContactsContract.AUTHORITY, "data/local-groups/#", LOCAL_GROUPS_ID);
        matcher.addURI(ContactsContract.AUTHORITY, "data/local-groups/filter", LOCAL_GROUPS_FILTER);
        matcher.addURI(ContactsContract.AUTHORITY, "data/local-groups/filter/*", LOCAL_GROUPS_FILTER);
    ...
    static {
        ...
        sDistinctDataProjectionMap.put(RawContacts.ACCOUNT_NAME, RawContacts.ACCOUNT_NAME);
        sDistinctDataProjectionMap.put(RawContacts.ACCOUNT_TYPE, RawContacts.ACCOUNT_TYPE);
    ...
    public void onAccountsUpdated(Account[] accounts) {
        ...
        try {
            // TODO: Now "NULL" account was NOT used any more.
            // so moving  contacts from "NULL" account to the first created writable account was NOT necessary now.
            // delete the related code once the local account and SimSource was ready.
